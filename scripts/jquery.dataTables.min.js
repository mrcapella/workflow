...
sEmptyTable:"No data available in table",sInfo:"Exibindo _START_ a _END_ de _TOTAL_ registros",sInfoEmpty:"Exibindo 0 a 0 registro",sInfoFiltered:"(filtro de _MAX_ total registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Exibir _MENU_ registros",sLoadingRecords:"Loading...",sProcessing:"Processando...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
